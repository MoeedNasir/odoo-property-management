...
class PropertyProperty(models.Model):
    ...
    # Added image field for main property image
    image_1920 = fields.Image("Main Image", max_width=1920, max_height=1920)

    # Added thumbnail fields for various sizes
    ...
    # Add these fields for attachments
    image_ids = fields.One2many('ir.attachment', 'res_id',domain=[('res_model', '=', 'property.property'), ('mimetype', 'ilike', 'image/%')],string='Property Images')
    document_ids = fields.One2many('ir.attachment', 'res_id',domain=[('res_model', '=', 'property.property'),('mimetype', 'not ilike', 'image/%')],string='Documents')
